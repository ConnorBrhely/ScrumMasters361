...
class TestCreateUser(TestCase):
    ...
    def setUp(self):
        ...
        self.confirmpassword = "Password123"
        self.email = "test@gmail.com"

    def test_create_user(self):
        resp = self.monkey.post("/create_user/", {"type": self.type, "name": self.name, "password": self.password, "confirmpassword": self.confirmpassword, "email": self.email}, follow=True)
        self.assertEqual(User.objects.count(), 1, msg="User not successfully created with valid information")
    ...
    def test_invalid_password(self):
        self.password = "password123"
        self.confirmpassword = "password123"
        resp = self.monkey.post("/create_user/", {"type": self.type, "name": self.name, "password": self.password, "confirmpassword": self.confirmpassword, "email": self.email}, follow=False)
    ...
    def test_short_password(self):
        self.password = "Test1"
        self.confirmpassword = "Test1"
        resp = self.monkey.post("/create_user/", {"type": self.type, "name": self.name, "password": self.password, "confirmpassword": self.confirmpassword, "email": self.email}, follow=False)
        self.assertEqual(User.objects.count(), 0, msg="object created with invalid password")
        self.assertEqual(resp.context["message"], "Passwords does not contain 8 characters with 1 uppercase letter and 1 number", msg="Correct error message not displayed with invalid password")

    def test_non_matching_passwords(self):
        self.confirmpassword = "Password1234"
        resp = self.monkey.post("/create_user/", {"type": self.type, "name": self.name, "password": self.password, "confirmpassword": self.confirmpassword, "email": self.email}, follow=False)
        self.assertEqual(User.objects.count(), 0, msg="object created with non matching passwords")
    ...
    def test_invalid_email(self):
        ...
        resp = self.monkey.post("/create_user/", {"type": self.type, "name": self.name, "password": self.password, "confirmpassword": self.confirmpassword, "email": self.email}, follow=False)
        self.assertEqual(User.objects.count(), 0, msg="object created with invalid email")
    ...
    def test_blank_fields(self):
        ...
        self.name = ""
        resp = self.monkey.post("/create_user/", {"type": self.type, "name": self.name, "password": self.password, "confirmpassword": self.confirmpassword, "email": self.email}, follow=False)
        self.assertEqual(User.objects.count(), 0, msg="object created with blank fields")
